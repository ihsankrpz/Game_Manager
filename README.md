...
![Game manager](/images/screenshot_1.png)
![Game manager](/images/screenshot-2.png)
...
- Clone the repository:
  `git clone https://github.com/ihsankrpz/Game_Manager.git`
...
- ENSEA students generation 2024 - TP 1